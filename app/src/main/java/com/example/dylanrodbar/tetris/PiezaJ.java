...
public class PiezaJ extends Pieza {
    ...
    public void asignarValoresBloques() {
        ...
        tipoPiezas[0].annadirPosiciones(2, 6, 1);
        tipoPiezas[0].annadirPosiciones(3, 6, 2);
        tipoPiezas[0].annadirPosiciones(3, 5, 3);
        ...
        tipoPiezas[2].annadirPosiciones(3, 5, 0);
        tipoPiezas[2].annadirPosiciones(2, 5, 1);
        tipoPiezas[2].annadirPosiciones(1, 5, 2);
        tipoPiezas[2].annadirPosiciones(1, 6, 3);

        tipoPiezas[3].annadirPosiciones(1, 4, 0);
        tipoPiezas[3].annadirPosiciones(1, 5, 1);
        tipoPiezas[3].annadirPosiciones(1, 6, 2);
